...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private ModelRenderable moonchairRenderable,sofaRenderable,lionRenderable,blackbedRenderable;

    ImageView sofa,lion,moonchair,blackbed;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sofa =(ImageView)findViewById(R.id.sofa);
         lion =(ImageView)findViewById(R.id.cupboard);
